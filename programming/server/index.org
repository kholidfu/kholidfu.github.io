...
Selanjutnya ikuti saja petunjuknya, kalau suka menyimpan key di
=~/.ssh/id_rsa.pub=. Untuk /passphrase/, silakan diisi sesuai
keinginan (kosong pun tidak masalah, tapi sebaiknya diisi).
...
#+BEGIN_SRC text
[remote "origin"]
    url = https://github.com/kholidfu/kholidfu.gitub.io.git
#+END_SRC
