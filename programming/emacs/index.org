...
menambahkan =emacs --daemon= (See [[sec:one][emacs as daemon]]) setiap kali komputer menyala.

Yak, =Ctrl+Alt+e=, dan /ZAP/! emacs nongol dan siap diajak kerja!
* Membuat tautan internal di emacs org-mode
...
/anchor text/ =Lihat bagian ini=.
* <<sec:five>>Emacs Good Reads
